...
Use `scripts/invoke_media_tool.py` for public URL download and local file-level media work. The wrapper delegates into the packaged `agent_toolbelt` Python package.
