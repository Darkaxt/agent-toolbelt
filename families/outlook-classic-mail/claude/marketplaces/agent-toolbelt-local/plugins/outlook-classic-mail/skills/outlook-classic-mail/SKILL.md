...
python scripts/invoke_outlook_mail.py save-attachments --account <smtp|store> --message-id <entry-id> --output-dir <directory>
...
python scripts/invoke_outlook_mail.py draft-reply --account <smtp|store> [--send-using-account <smtp|store>] --message-id <entry-id> [--reply-mode sender|all] [--to <recipient>] [--cc <recipient>] [--bcc <recipient>] --instruction "<guidance>" [--body "<final draft text>" [--attach <local-file>] --create-draft --confirm]
python scripts/invoke_outlook_mail.py draft-forward --account <smtp|store> [--send-using-account <smtp|store>] --message-id <entry-id> --to "<recipient>" [--cc <recipient>] [--bcc <recipient>] --instruction "<guidance>" [--body "<final draft text>" [--attach <local-file>] --create-draft --confirm]
python scripts/invoke_outlook_mail.py edit-draft --account <smtp|store> --message-id <draft-entry-id> [--body "<final draft text>"] [--subject <subject>] [--to <recipient>] [--cc <recipient>] [--bcc <recipient>] [--attach <local-file>] --confirm
