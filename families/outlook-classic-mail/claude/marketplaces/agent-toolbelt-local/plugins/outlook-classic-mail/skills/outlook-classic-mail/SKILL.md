...
python scripts/invoke_outlook_mail.py draft-reply --account <smtp|store> [--send-using-account <smtp|store>] --message-id <entry-id> [--reply-mode sender|all] [--to "<recipients>"] [--cc "<recipients>"] [--bcc "<recipients>"] [--attach <path>] --instruction "<guidance>" [--body "<final draft text>" --create-draft --confirm]
python scripts/invoke_outlook_mail.py draft-forward --account <smtp|store> [--send-using-account <smtp|store>] --message-id <entry-id> --to "<recipient>" [--cc "<recipients>"] [--bcc "<recipients>"] [--attach <path>] --instruction "<guidance>" [--body "<final draft text>" --create-draft --confirm]
python scripts/invoke_outlook_mail.py apply-action --account <smtp|store> --message-id <entry-id> --action <create-draft|send|move|delete|category|mark-read> [--cc "<recipients>"] [--bcc "<recipients>"] [--attach <path>] --confirm
```
