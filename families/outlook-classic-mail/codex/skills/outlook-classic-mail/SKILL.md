...
- Use `draft-reply --reply-mode all` when the user wants all Outlook thread recipients. Use explicit `--to`, `--cc`, or `--bcc` when the user names a specific recipient set. Do not create a draft and then patch recipients through ad hoc COM.
