...
class OutlookClassicMailBridgeTests(unittest.TestCase):
    ...
    def test_codex_skill_documents_draft_thread_and_sender_diagnostics(self):
        ...
        self.assertIn("send_using_account_selection.source", skill_text)
        self.assertIn("derives the sender from the anchor message's original recipient SMTP addresses", skill_text)
